    ...
    <main className="flex flex-1 flex-col">
      ...
      <PageHero
        ...
        breadcrumbs={[
          { href: "/", label: "الرئيسية" },
          ...(coupon.store
            ? [{ href: `/stores/${coupon.store.slug}`, label: storeName }]
            : []),
          { label: coupon.title_ar },
        ]}
        title={coupon.title_ar}
        subtitle={coupon.description_ar ?? undefined}
        aside={
          coupon.store ? (
            <Link
      ...
      >
        {/* Eyebrow chips: store name + exclusive + discount badges */}
        ...
        {/* Meta row: expiry + verification + success-rate */}
        ...
        <div className="pt-2">
          {isExpired ? (
            ...
            <CouponRevealHero
              ...
              storeSlug={coupon.store?.slug ?? undefined}
            />
          )}
        </div>
        ...
        <div className="flex flex-wrap items-center gap-4">
          <a
            ...
            className="font-body inline-flex items-center gap-1.5 text-xs text-white/65 transition-colors hover:text-white"
          ...
          <Link
            ...
            className="font-body inline-flex items-center gap-1.5 text-xs text-white/45 transition-colors hover:text-white/75"
          >
