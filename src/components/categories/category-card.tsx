...
export function CategoryCard({ category, className }: CategoryCardProps) {
  ...
  return (
    <Link
      ...
      className={cn(
        "group bg-cream-dark/30 border-brand-gold/20 hover:border-brand-green/40 hover:bg-brand-green/5 flex flex-col items-center gap-3 rounded-2xl border p-6 transition-all duration-200 hover:-translate-y-0.5",
        className
      )}
    >
